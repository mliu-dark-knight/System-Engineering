...
int main(void)
{
    ...
    // ece391_fdputs (1, (const uint8_t*) "rtc opened\n");

    add_frames(file0, file1, rtc_fd);
    // ece391_fdputs (1, (const uint8_t*) "frame added\n");
    ...
    // ece391_fdputs (1, (const uint8_t*) "tasklet\n");
    ...
    // ece391_fdputs (1, (const uint8_t*) "ioctl\n");
...
add_frames(uint8_t *f0, uint8_t *f1, int32_t rtc_fd)
{
    ...
    if( (fd0 = ece391_open(f0)) < 0 ) {
        // ece391_fdputs (1, (const uint8_t*) "fd0 open failed\n");
        ece391_halt(-1);
    }
    if( (fd1 = ece391_open(f1)) < 0 ) {
        // ece391_fdputs (1, (const uint8_t*) "fd1 open failed\n");
        ece391_halt(-1);
    }
